...
public class BookFacade {
    ...
    public static void main(String[] args) {
         EntityManagerFactory emf = Persistence.createEntityManagerFactory("pu");      
            ...
            Book b1 = facade.addBook("J.K. Rowling");
            Book b2 = facade.addBook("John Doe");
            //Find book by ID
    ...
    // En metode til at hente et bog objekt ind ved at tjekke om objektet findes:
    ...
    // En metode der tilføjer en bog til databasen:
    ...
    // En metode til at finde et bog objekt i databasen via dets id:
    ...
    // En metode der lister alle bog objekterne op fra databasen:
